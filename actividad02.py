...
lbl_altura_vuelo = tk.Label(ventana, text="Altura de vuelo(pixel)")
...
def calcular():
    ...
    baseAerea = calcular_Base_Aerea(ancho_img, solape_l)
    distanciaEntrePasadas = calcular_Distancia_Entre_Pasadas(alto_img, solape_t)
